...
public class FightGUI implements GUI {
    ...
    public void render() {
        ...
        AtomicInteger heroHeight = new AtomicInteger((int) (-50*scale));
        ...
        for (DrawnHero hero : heroes) {
            renderableHeros.add(() -> {
                ...
                hero.draw(spriteBatch, scaledResolution.getCenterX(), scaledResolution.getCenterY(), (int) (heroHeight.get() *scale));
    ...
    class DrawnGoblin {
        ...
        public void draw(SpriteBatch spriteBatch, int x, int y, int height) {
            ...
            spriteBatch.draw(phase.getGoblinTextures()[frame], x + this.x*scale, y+height+75*scale, 256*2*scale, 256*2*scale);
        }
    }
    ...
    class DrawnHero {
        ...
        public void draw(SpriteBatch spriteBatch, int x, int y, int height) {
            ...
            spriteBatch.draw(phase.getHeroTexture()[frame], x + this.x*scale, y+height, 256*3*scale, 256*3*scale);
